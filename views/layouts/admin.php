...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-section">
      ...
      <ul>
        <li class="nav-item"><a href="<?= adminUrl('/admin/expenses') ?>" class="<?= isActive('/admin/expenses') && $currentUri === (defined('SUBFOLDER') ? SUBFOLDER : '') . '/admin/expenses' ? 'active' : '' ?>">
          <span class="nav-icon"><i class="fa-solid fa-chart-pie"></i></span> Pengeluaran
        </a></li>
        <li class="nav-item"><a href="<?= adminUrl('/admin/expenses/fuel') ?>" class="<?= isActive('/admin/expenses/fuel') ? 'active' : '' ?>">
          <span class="nav-icon"><i class="fa-solid fa-gas-pump"></i></span> Bensin Per Trip
        </a></li>
        <li class="nav-item"><a href="<?= adminUrl('/admin/expenses/service') ?>" class="<?= isActive('/admin/expenses/service') ? 'active' : '' ?>">
          <span class="nav-icon"><i class="fa-solid fa-screwdriver-wrench"></i></span> Servis Kendaraan
        </a></li>
        <li class="nav-item"><a href="<?= adminUrl('/admin/expenses/salaries') ?>" class="<?= isActive('/admin/expenses/salaries') ? 'active' : '' ?>">
          <span class="nav-icon"><i class="fa-solid fa-money-bill-wave"></i></span> Gaji Supir
        </a></li>
        <li class="nav-item"><a href="<?= adminUrl('/admin/expenses/drivers') ?>" class="<?= isActive('/admin/expenses/drivers') ? 'active' : '' ?>">
          <span class="nav-icon"><i class="fa-solid fa-user-tie"></i></span> Data Supir
        </a></li>
      </ul>
    </div>
    <div class="nav-section">
